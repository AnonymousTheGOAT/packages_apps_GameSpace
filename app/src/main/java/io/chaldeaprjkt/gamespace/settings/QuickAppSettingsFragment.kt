...
class QuickAppSettingsFragment : Fragment(R.layout.quick_start_app_layout) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        putAppsForUser("", Action.SET)
    }

    private fun getTitle(): Int {
        return R.string.quick_start_apps_title
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        optionsMenu = menu
        inflater.inflate(R.menu.quick_start_app_menu, menu)
    ...
    private fun onListUpdate(packageName: String, isChecked: Boolean) {
        ...
        if (isChecked) {
            putAppsForUser(packageName, Action.ADD)
        } else {
            putAppsForUser(packageName, Action.REMOVE)
        }
        try {
                ...
                .filter {
                    if (!showSystem) {
                        !it.applicationInfo!!.isSystemApp() &&
                            !resources
                                .getStringArray(R.array.quick_start_app_hidden_apps)
                                .asList()
    ...
    private inner class AppListAdapter : ListAdapter<AppInfo, AppListViewHolder>(itemCallback) {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
            AppListViewHolder(
                layoutInflater.inflate(R.layout.quick_start_app_list_item, parent, false)
            )
    ...
    companion object {
        ...
        private const val QUICK_START_APPS = "quick_start_apps"
    }
}
